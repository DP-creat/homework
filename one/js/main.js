document.addEventListener('DOMContentLoaded', () => {
    ...
    class Spark {
        constructor(id) {
            ...
            // 7 НЕОНОВЫХ ЦВЕТОВ РАДУГИ (RGB формат)
            const rainbowNeon = [
                '255, 0, 85',   // Red (Neon Pink/Red)
                '255, 135, 0',  // Orange (Vivid Orange)
                '255, 255, 0',  // Yellow (Bright Neon)
                '0, 255, 120',  // Green (Neon Lime)
                '0, 242, 255',  // Cyan (Electric Blue)
                '122, 53, 255', // Indigo (Deep Purple)
                '255, 0, 255'   // Violet (Hot Magenta)
            ];

            // Распределяем цвета по порядку 1, 2, 3... 7, 1, 2...
